...
export default function Contact() {
  ...
  return (
    <>
      ...
      {/* Footer */}
      <footer className="border-t border-line py-12 md:py-16 relative overflow-hidden">
        ...
        <div className="mx-auto max-w-site px-5 sm:px-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            <div>
              <span className="font-display italic text-[28px] text-gradient">
                Samir Hasan
              </span>
              <p className="mt-1.5 text-[12px] font-mono text-ink-3 tracking-wide uppercase">
            ...
            <div className="flex flex-wrap items-center gap-4">
              {[
                { label: 'Twitter',  href: '#' },
                { label: 'LinkedIn', href: 'https://www.linkedin.com/in/samir-hasan-18048524a/' },
                { label: 'GitHub',   href: '#' },
                { label: 'Substack', href: '#' },
              ].map((s) => (
                <a
                  ...
                  className="text-[12px] font-mono text-ink-3 hover:text-white transition-colors tracking-wide relative group"
                  data-cursor
                >
                  {s.label}
                  <span className="absolute -bottom-0.5 left-0 h-px w-0 group-hover:w-full bg-accent/50 transition-all duration-300" />
                </a>
              ))}
            </div>
          </div>
          <div className="mt-10 pt-6 border-t border-line flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 text-[11px] font-mono text-ink-3">
            <span>© 2026 Samir Hasan. All rights reserved.</span>
            <span>Built with purpose · Dhaka, BD</span>
          </div>
        </div>
      </footer>
    </>
